...
defaultTextFormField(
{
  ...
  Color color =const Color(0xff36393B),
  ...
  child:   TextFormField(
    style: TextStyle(color: Color(0xFFF3BA35),fontSize: 20),
      decoration: InputDecoration(
       ...
       label: Row(children: [
         ...
         SizedBox(width: 3,),
         Text(text2,style: TextStyle(fontSize: 15,color: Color(0xFFFFCA34)),),

       ],),
        labelStyle: TextStyle(fontSize:fontsize,color: color ),
        suffixIcon: Padding(
          padding: const EdgeInsets.only(top: 18.0),
          child: Icon(con,color: Color(0xFF9B9FBB),size: 20,),
        ),
        hintText: hint,
      ...
      Container(
        child: Row(
          ...
          Padding(
            ...
            child: Image.asset("images/logo15.png"),
          )
        ...
        child: Column(
          ...
          Padding(
            ...
            child: Row(
              ...
              InkWell(child: text1(fontSize: 23, text: "",color: Color(0xFFFCB70A))),
      ...
      child: Row(
        ...
        Column(children: [
          ...
          Padding(
            ...
            child: text1(fontSize: 24, text: "خالد محمود",color: Color(0xFF182061)),
          ),
          ...
          Padding(
            padding: const EdgeInsets.only(left: 70),
            child: text1(fontSize: 19, text: "على بعد : 20 ك",color: Color(0xFF182061)),
          ),
        ...
        defaulCircleAvatar2(image: "assets/images/logo16.png",raduis: 40,),
  ...
  child: Row(
    ...
    children: [
      Row(children: [
        Padding(
          padding: const EdgeInsets.only(left: 10),
          child: text1(fontSize: 23, text: "درهمً",color: Color(0xFF182061)),
      ...
      Padding(
        padding: const EdgeInsets.only(right: 10),
        child: text1(fontSize: 23, text: "المجموع -",color: Color(0xFF182061)),
      ),
...
defautContainar35()=>Padding(
  ...
  child:   Container(
    ...
    child: Row(
      ...
      Padding(
        padding: const EdgeInsets.only(left: 10),
        child: Image.asset("images/loooo4.png",),
      ),
...
defautContainar45()=>Container(
  ...
  child: Row(
    ...
    Padding(
      ...
      child: Image.asset("images/loooo11.png",),
    ),
    SizedBox(width: 70,),
              ...
              child: Column(
                ...
                Padding(
                  ...
                  child: Row(children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.only(right: 10),
                      child: Image.asset("images/logo56.png"),
                    ),
        ...
        child: Column(
          ...
          Padding(
            ...
            child: Column(children: [
              ...
              Image.asset("images/loooo14.png"),
            ],),
          )
