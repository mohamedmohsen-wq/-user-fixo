        ...
        children: [
          Container(
            ...
            child: Column(
              children: [
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(tx8,
                              textDirection: TextDirection.rtl,
                              style: TextStyle(fontSize: 17,color: const Color(0xffCC9D1A),),),
                            Text.rich(
                              TextSpan(
                                  text: tx9,
                                  style: TextStyle(
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          textDirection: TextDirection.rtl,
                          children: [
                            Text(tx15,textDirection:TextDirection.rtl,style: TextStyle(fontSize: 17,color: Color(0xff182061),),
                            ),
                            Text.rich(
                              TextSpan(
                                  text: tx16,
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          textDirection: TextDirection.rtl,
                          children: [
                            Text(tx18,textDirection:TextDirection.rtl,style: TextStyle(fontSize: 17,color: Color(0xff182061),),
                            ),
                            Text.rich(
                              TextSpan(
                                  text: tx19,
                ...
                SizedBox(height: 7,),
                Text("(شامل ضريبة القيمة المضافة)",style: TextStyle(
                  color: Color(0xff182061),
                  fontSize: 16
                ),)
              ],
          ...
          Positioned(
            child: Container(
              ...
              decoration: BoxDecoration(
                image:
                    DecorationImage(image: AssetImage("images/Group 37572.png")),
              ),
            ),
            top: 11,
            left: 10,
