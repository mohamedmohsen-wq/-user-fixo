...
class Screen146 extends StatelessWidget {
  const Screen146({Key? key}) : super(key: key);
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      }, icon:Image.asset("souqFixoImages/Group 38389.png",width: 30,height: 30,)),
                      Text(
                        "العناوين المحفوظة",
                        style: TextStyle(
                          fontSize: 27,
              ...
              child: Column(
                ...
                children: [
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Icon(Icons.delete,color: Color(0xffE8333A),),
                      Row(
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Icon(Icons.edit,color: Color(0xff28AF31),),
